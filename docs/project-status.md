...
- Current branch: `feat/cyber-control-assurance-and-reassessment`, created from merged `main` commit `781ab65` after PR #62 closed the manual-retest submission UX follow-up. The active product-hardening milestone distinguishes customer control assertions from verified facts, adds risk-based evidence and quote acceptance gates, and preserves immutable quote versions during reassessment. See `docs/dev/cyber-control-assurance-and-reassessment-design.md` and the executable plan under `docs/superpowers/plans/2026-07-12-cyber-control-assurance-and-reassessment.md`.
