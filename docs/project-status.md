...
- Current milestone: Milestone 23 - Underwriting Workbench UI Foundation has started on branch `codex/milestone-23-underwriting-workbench-ui-foundation`. It should add a protected frontend workbench for underwriters to list referred quotes, inspect referral context, request advisory AI review, and record manual approve/decline/adjust decisions through the existing backend endpoints without changing underwriting authority rules.
