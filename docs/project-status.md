...
- Current milestone: Milestone 22 - AI Underwriting Assistant Foundation is complete on branch `codex/milestone-22-ai-underwriting-assistant-foundation`. It adds advisory-only AI support for referred quote underwriting review with stored audit evidence, explicit human authority boundaries, and failure-safe behavior that never lets AI approve, decline, price, bind, issue, or otherwise make insurance decisions.
