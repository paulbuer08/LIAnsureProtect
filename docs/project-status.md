...
- Current branch: `feat/milestone-39-quoting-decision-boundary`. Work now flows through GitHub pull requests into a protected `main` (CI-gated); do not commit directly to `main`.
...
- Latest closed milestone: Milestone 39 - Quoting Decision Boundary.
- Current milestone: Milestone 39 - Quoting Decision Boundary, complete on branch `feat/milestone-39-quoting-decision-boundary`. See `docs/dev/milestone-39-quoting-decision-boundary-design.md`, `docs/superpowers/plans/2026-07-02-milestone-39-quoting-decision-boundary.md`, and `docs/dev/milestone-39-quoting-decision-boundary-learnings.md`.
...
- Recommended next milestone after M39: `Milestone 40 - Dispatcher Integration Event Decoupling`. The Quoting decision boundary is now explicit enough for the next slice to reduce the centralized dispatcher/event-mapper coupling without forcing a broad quote/rating/policy table move yet.
