...
- Current milestone: Milestone 22 - AI Underwriting Assistant Foundation has started on branch `codex/milestone-22-ai-underwriting-assistant-foundation`. It should add advisory-only AI support for underwriting review with stored audit evidence, explicit human authority boundaries, and failure-safe behavior that never lets AI approve, decline, price, bind, issue, or otherwise make insurance decisions.
