...
namespace LIAnsureProtect.Modules.Claims.Infrastructure.Migrations
{
    ...
    [Migration("20260703183611_AddClaimDecisions")]
    partial class AddClaimDecisions
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("LIAnsureProtect.Modules.Claims.Domain.Claim", b =>
                {
                    ...
                    b.Property<string>("DenialNarrative")
                        .HasMaxLength(2000)
            ...
            modelBuilder.Entity("LIAnsureProtect.Modules.Claims.Domain.ClaimDecision", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
                    ...
                    b.Property<decimal?>("ClaimedAmountAtDecision")
                        .HasPrecision(18, 2)
                        .HasColumnType("numeric(18,2)")
                    ...
                    b.Property<decimal>("ReserveAmountAtDecision")
                        .HasPrecision(18, 2)
                        .HasColumnType("numeric(18,2)")
                    ...
                    b.HasIndex("ClaimId", "DecidedAtUtc")
                        .HasDatabaseName("ix_claim_decisions_claim_id_decided_at_utc");

                    b.ToTable("claim_decisions", "claims");
                });
