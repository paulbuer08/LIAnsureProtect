...
namespace LIAnsureProtect.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260626074123_AddNotificationInbox")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("LIAnsureProtect.Domain.Quotes.AiUnderwritingReview", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
                    ...
                    b.ToTable("ai_underwriting_reviews", (string)null);
                });
            ...
            modelBuilder.Entity("LIAnsureProtect.Domain.Quotes.QuoteReferralFollowUpTask", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
                    ...
                    b.ToTable("quote_referral_follow_up_tasks", (string)null);
                });

            modelBuilder.Entity("LIAnsureProtect.Domain.Quotes.QuoteReferralOperation", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
                    ...
                    b.ToTable("quote_referral_operations", (string)null);
                });

            modelBuilder.Entity("LIAnsureProtect.Domain.Quotes.QuoteReferralTimelineEntry", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
                    ...
                    b.ToTable("quote_referral_timeline_entries", (string)null);
                });

            modelBuilder.Entity("LIAnsureProtect.Domain.Quotes.QuoteReferralWorkNote", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
                    ...
                    b.ToTable("quote_referral_work_notes", (string)null);
                });
            ...
            modelBuilder.Entity("LIAnsureProtect.Infrastructure.Persistence.Notifications.NotificationInboxEntry", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
                    ...
                    b.ToTable("notification_inbox_entries", (string)null);
                });
            ...
            modelBuilder.Entity("LIAnsureProtect.Domain.Quotes.QuoteEvidenceRequest", b =>
                {
                    ...
                    b.HasOne("LIAnsureProtect.Domain.Quotes.QuoteReferralOperation", null)
                        .WithMany()
